                        ...
                        <CardBody className='flex flex-col grow justify-center'>
                            ...
                            <div className='flex flex-col items-center justify-center'>
                                ...
                                <Typography className='text-center text-lg my-5'>
                                    Si elegiste pagar por transferencia, por favor seguí las siguientes instrucciones!
                                </Typography>
                                ...
                                <Typography className='my-5 text-lg text-center'>
                                    Una vez realizada la transferencia, enviamos el comprobante junto con el número de orden al siguiente teléfono por WhatsApp <span className='font-bold underline inline-block'>261-221-3244</span> para confirmar tu pedido.
                                </Typography>

                                <Typography className='text-center my-5' variant='h5'>
                                    Tu pedido estará llegando en las próximas <span className='underline'>24 horas</span>
                                </Typography>
