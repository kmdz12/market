                ...
                <div className="flex-none h-[32rem]">
                    <div className="h-full w-full bg-cover bg-no-repeat intro bg-center flex justify-center items-center" title='Foto de amoon.ra en Unsplash'>
                        <div className="select-none text-center">
                            <Typography variant="h1" color="white" className="text-3xl md:text-5xl tracking-wide focus-in-expand">Kilómetro 12</Typography>
                ...
                <div className='background'>
                    <div>
                        <div className="md:container md:mx-auto m-2 flex my-5 bg-white rounded-lg border-y-2 border-black">
                            <div className="p-5">
                                <Typography variant="h2" color="black" className="sm:text-center">Cómo Funciona?</Typography>
                            </div>
                        </div>
                        ...
                        <div className="md:container md:mx-auto flex flex-col sm:flex-row bg-white rounded-lg divide-y md:divide-x">
                            <div className="mx-auto px-7 py-3 flex flex-col items-center md:w-1/3">
                                ...
                                <Typography variant="paragraph" className="text-center md:text-left">Busca tus frutas y vegetales deseados, usando la barra de búsqueda o explorando nuestra lista de productos.</Typography>
                            </div>
                            ...
                            <div className="mx-auto px-7 py-3 flex flex-col items-center md:w-1/3">
                                ...
                                <Typography variant="paragraph" className="text-center">Agrega los items seleccionados a tu carrito y completa con tus datos para el envío!</Typography>
                            </div>
                            ...
                            <div className="mx-auto px-7 py-3 flex flex-col items-center md:w-1/3">
                                ...
                                <Typography variant="paragraph" className="text-center">Realiza tu orden, paga con tu medio preferido y listo! Relájate mientras preparamos tu pedido.</Typography>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className="md:container md:mx-auto m-2 flex my-5 bg-white rounded-lg border-y-2 border-black">
                            <div className="p-5">
                                <Typography variant="h2" color="black" className="text-center md:text-left">Trabaja con Kilómetro 12</Typography>
                            </div>
                        </div>
                        ...
                        <div className="md:container md:mx-auto flex flex-col bg-white rounded-lg divide-y mb-5">
                            <div className="my-2 md:container md:mx-auto flex flex-col items-center md:flex-row md:justify-evenly">
                                ...
                                <div className="flex flex-col items-center mx-4 basis-1/4">
                                    <Typography variant="lead" className="m-2 text-center">Cómo Delivery</Typography>
                                    <Typography variant="paragraph" className="m-2 text-center">Encargate de entregar nuestros pedidos, todo lo que necesitas es un vehículo!</Typography>
                            ...
                            <div className="my-2 md:container md:mx-auto flex flex-col items-center md:flex-row-reverse md:justify-evenly">
                                ...
                                <div className="flex flex-col items-center mx-4 basis-1/4">
                                    <Typography variant="lead" className="m-2 text-center">Cómo Partner</Typography>
                                    <Typography variant="paragraph" className="m-2 text-center">Ayúdanos a proveer a las personas con las frutas y vegetales más frescos.</Typography>
                                    <Button variant="outlined" size="md" className="w-48 rounded-none border-2 border-black m-2 shadow-pop-br">
                            ...
                            <div className="my-2 md:container md:mx-auto flex flex-col items-center md:flex-row md:justify-evenly">
                                ...
                                <div className="flex flex-col items-center mx-4 basis-1/4">
                                    <Typography variant="lead" className="m-2 text-center">Cómo Equipo</Typography>
                                    <Typography variant="paragraph" className="m-2 text-center">Se parte del equipo que está detrás de esta plataforma.</Typography>
                                    <Button variant="outlined" size="md" className="w-48 rounded-none border-2 border-black m-2 shadow-pop-br">
                            ...
                            <div className="my-2 md:container md:mx-auto flex flex-col items-center md:flex-row-reverse  md:justify-evenly">
                                ...
                                <div className="flex flex-col items-center mx-4 my-4 basis-1/4">
                                    ...
                                    <Typography variant="paragraph" className="m-2 text-center">Sabemos que podes tener alguna duda con respecto a medios de pago o cobertura, pero no temas, aquí vas a poder algunas preguntas frecuentes que puedes llegar a tener!</Typography>
                                    <Button variant="outlined" size="md" className="w-48 rounded-none border-2 border-black m-2 shadow-pop-br">
